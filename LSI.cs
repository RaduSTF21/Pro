...
namespace Proiect_info
{
    ...
    public class LSI
    {
        ...
        protected void Rezolva_e()
        {
            ...
            p = head;
            Console.WriteLine("Numarul de litere este : " + (n + 1));
            Console.Write(p.info + " ");
            for (int i = 1; i < n; i++)
            {
                p = p.leg;
